            ...
            $user= new usuario();
                ...
                <tr>
                    ...
                    <td><?php echo $fila["cargo"]; ?></td>
                        ...
                        <td>
                        	<a href="#mod" class="update_user show-select-rol" data-toggle="modal" data-target="#usr-update-info" data-rol-type="select" data-tipo="1" data-method="actualizar" data-usuarios_id="<?php echo $fila['idusuarios']; ?>"  ><i class="fa fa-lock" ></i> Modificar</a></td>
                        
                        <td>
                        	<a href="#del" class="select-usr-delete <?php if ($fila["idusuarios"]==$_SESSION["id"]){ echo 'grisC';}?> " <?php if ($fila["idusuarios"]!=$_SESSION["id"]){  ?> data-toggle="modal" data-target='#msj-eliminar'  <?php }?> data-status='3'  data-usuarios_id="<?php echo $fila['idusuarios']; ?>"   >
