...
--
-- Host: localhost
-- Generation Time: Apr 11, 2017 at 11:12 pm
...
INSERT INTO `contribuyentes` (`contribuyente_id`, `rif`, `razon_social`, `domicilio`, `parroquia_id`, `telefono`, `fax`, `correo`, `cierre_fiscal`, `actividad`) VALUES
(1, '1', '1', '1', 6, '1', '1', '1', '2012-02-02', '1'),
(2, '1', '1', '1', 6, '1', '1', '1', '2012-02-02', '1'),
(3, '1', '1', '1', 6, '1', '1', '1', '2012-02-02', '1'),
(4, '1', '1', '1', 6, '1', '1', '1', '2012-02-02', '1'),
(5, '1', '1', '1', 6, '1', '1', '1', '2012-02-02', '1');
...
CREATE TABLE `inspeccion` (
  ...
  `tipo_ente` varchar(45) DEFAULT NULL,
  `rif` varchar(45) DEFAULT NULL,
  `funcionario` varchar(45) DEFAULT NULL,
  `observacion` varchar(45) DEFAULT NULL,
  `status` int(11) DEFAULT '1' COMMENT 'estatus de la inspeccion'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `inspeccion` (`idinspeccion`, `razon_social`, `tipo_ente`, `rif`, `funcionario`, `observacion`, `status`) VALUES
(1, 'comercial prueba', 'abasto', 'V32131231', 'stefany mejia', 'nada', 1),
(2, 'prueba2', 'comercial', 'J12312312', 'julian sanchez', '', 1),
(3, 'prueba3', 'comercial 1', 'E312312312', 'Jose Gonzalez', '', 1),
(4, 'prueba4', 'abasto', 'V8892312', 'jose perez', 'malo', 1),
(5, 'SuperMercado MercaOferta', 'Abasto', 'V147833497', 'MARIA LEONOR', 'ABIERTO', 1),
(6, 'adasd', 'sdasd', 'V123213123', 'sdad', 'ABIERTO', 1),
(7, 'prueba', 'putos', 'V123123', 'darwin', 'malo', 1),
(8, 'see', 'se', 'V1111', 'see', 'se', 1),
(9, 'see', 'se', 'V1111', 'see', 'se', 1);
...
INSERT INTO `representante` (`representante_id`, `contribuyente_id`, `nombre`, `apellido`, `rif`, `correo`, `telefono`) VALUES
(1, 4, '1', '1', '1', '1', '1'),
(2, 5, '1', '1', '1', '1', '1');
...
INSERT INTO `usuarios` (`idusuarios`, `seudonimo`, `clave`, `cedula`, `nombre`, `apellido`, `cargo`, `creado`, `status`, `rol`) VALUES
(2, 'admin', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', 12345, 'oscar', 'lopez', 'gerente', '2017-04-21 15:22:45', 1, 1),
(3, 'darwinvas', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 20122996, 'darwin', 'vasquez', 'secretario', '0000-00-00 00:00:00', 1, 2);
...
ALTER TABLE `contribuyentes`
  ADD PRIMARY KEY (`contribuyente_id`);
...
--
ALTER TABLE `contribuyentes`
  MODIFY `contribuyente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `inspeccion`
  MODIFY `idinspeccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `representante`
  MODIFY `representante_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
