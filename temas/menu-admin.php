<ul id="accordion" class="accordion vin-listados show-menu-left" data-id_rol="<?php echo 1 ?>">
		<li class="Administracion">
			<div class="link"  ><a href="admin.php"><i class="fa fa-list-ul" ></i><b>Resumen</b></a></div>
			
		</li>
		
		<li class="admin-usuarios">
			<div class="link"><a href="register.php" class=""><i class="fa fa-user "></i>Registrar Nueva Inspeccion</a></div>			 
		</li>
